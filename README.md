...
| **5주차**<br>2026.04.10 | `Week5_네이버웹툰_크롤링.ipynb` | - 정적 크롤링(BeautifulSoup) vs 동적 크롤링(Selenium) 비교 실험<br>- React 기반 SPA(네이버 웹툰) 동적 크롤링 실습<br>- Selenium + headless Chrome을 활용한 "이달의 신규 웹툰" 제목·작가·내용 스크래핑<br>- WebDriverWait를 활용한 명시적 대기 및 CSS 부분 매칭 셀렉터 활용 |
